...
\begin{itemize}
  ...
  instance additional resources. The hierarchical design depends on a particular
...
\begin{itemize}
  ...
  channel without the pre-rotation, where the amplitude of the fading coefficients related to the sources
