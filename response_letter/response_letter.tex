...
\begin{itemize}
  ...
  scenarios even with the relaxed assumption (pre-rotation off). In addition we shown that the
  performance of the proposed framework is even above the corresponding reference theoretical limits.
\end{itemize}
...
\begin{itemize}
  ...
  \item A: The nomenclature is placed according to the EURASIP-author's guidelines.
\end{itemize}
