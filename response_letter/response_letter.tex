...
\begin{itemize}
  ...
  "wireless aware" due to its randomness. There remains scope for searching proper network
  ...
  constellation design that allow some overlaps in the received constellation, such that only a
  ...
  hierarchical as the \emph{basic} stream. Since the basic stream is needed at the destinations, it is
  ...
  sources. A design of some useful rules for the proposed building block utilization is an open
