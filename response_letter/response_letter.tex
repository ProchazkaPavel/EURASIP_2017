...
\begin{itemize}
  ...
  \item A: We should stress that the modulation design covers both
  wireless network coding and processing the signal from multiple stages. Join generalization of
  both phenomenons in the way we did would be extremely challenging, because of synchronization,
  pre-rotation, etc. Also note that our approach is basically a practical instance of a well known
  ...
  theoretical level is already known. This answers also general comments.
\end{itemize}
...
\begin{itemize}
  ...
  \item A: The intuition beyond the design could be partly found in ICC (TODO)
\end{itemize}
