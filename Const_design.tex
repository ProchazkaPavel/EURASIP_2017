...
For a more relevant comparison of the proposed method, we consider two conventional \emph{3-step}
...
applied) and thus the HSI channels are completely ignored.
...
\par\end{centering}
\centering{}\caption{Performance comparison .\label{fig:CTUpp_comparison-schemaa}}
\end{figure}
...
\par\end{centering}
\centering{}\caption{Performance comparison .\label{fig:CTUpp_comparison-schemab}}
\end{figure}
