...
\maketitle
{\footnotesize{}The corresponding author D. Halls is with the Toshiba
-- Telecommunication Research Laboratory (email: david.halls@toshiba-trel.com).
Pavel Prochazka, Tomas Uricar and Jan Sykora were with the Czech Technical
University in Prague, Czech Republic (e-mail: \textbackslash{}\{prochp10,
uricatom, Jan.Sykora\textbackslash{}\}@fel.cvut.cz). }{\footnotesize \par}
...
Coding} (WNC) and we show that the design of novel adaptive constellations\emph{
...
of channel SNRs. To further support the applicability of the proposed
...
\subsubsection*{Keywords:}Wireless Network Coding, Butterfly Network, Relaying, Superposition
...
\begin{figure}
\begin{centering}
\hspace*{-0.04\columnwidth}\includegraphics[width=0.95\columnwidth]{fig/Throughput_HSI_XOR_MAC16_BC20_N2}\vskip-2ex
\par\end{centering}
...
\begin{figure}
\begin{centering}
\hspace*{-0.04\columnwidth}\includegraphics[width=0.95\columnwidth]{fig/Throughput_HSI_XOR_MAC17_BC17_N2}\vskip-2ex
\par\end{centering}
...
\begin{figure}
\begin{centering}
\hspace*{-0.04\columnwidth}\includegraphics[width=0.95\columnwidth]{fig/Throughput_HSI_XOR_MAC20_BC20_N2}\vskip-2ex
\par\end{centering}
...
\begin{figure}
\begin{centering}
\hspace*{-0.04\columnwidth}\includegraphics[clip,width=0.95\columnwidth]{fig/Throughput_HSI_XOR_MAC20_BC16_N2}\vskip-2ex
\par\end{centering}
